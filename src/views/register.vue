                  ...
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="4" class="py-1 px-0 text-center mr-1">
                      ...
                      <v-text-field
                        ...
                        class="pa-0 mb-5"
                      ></v-text-field>
                      <v-btn @click="register()" class="white indigo--text mb-12" icon fab>
  ...
  methods: {
    register() {
      ...
      if (
        ...
        this.response.status = "error";
        this.response.message = "PIN não corresponde";
        this.e1 = 2;
        this.loader = false;
        this.snackbar = true;
        return;
        ...
        setTimeout(() => {
          ...
          localStorage.setItem(
            String(this.new_user.acct_no),
            String(this.new_user.pin)
          );
